...
const getItems = async () => {
    try {
        ...
        const url = `https://www.guitarcenter.com/Used?icid=LP8673&filters=stores:Maple%20Grove|Bloomington|Oakdale|Twin%20Cities&Ns=cD&recsPerPage=100&facetChangeCategory=Amplifiers%20%26%20Effects`;
...
export const GET: APIRoute = async () => {
    try {
        const data = await getItems(); // TODO dedupe list
